  ...
  <div>
    ...
    <div v-else>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div class="glass-card p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm text-gray-500 dark:text-gray-400">今日新品发现</p>
        ...
        <div class="glass-card p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm text-gray-500 dark:text-gray-400">潜力爆品推荐</p>
              <p class="text-2xl font-bold text-gray-800 dark:text-white mt-1">
        ...
        <div class="glass-card p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm text-gray-500 dark:text-gray-400">收藏产品数</p>
              <p class="text-2xl font-bold text-gray-800 dark:text-white mt-1">
        ...
        <div class="glass-card p-6">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm text-gray-500 dark:text-gray-400">AI 推荐准确率</p>
              <p class="text-2xl font-bold text-gray-800 dark:text-white mt-1">
      ...
      <div class="glass-card p-6 mb-8">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">快速搜索</h2>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div class="glass-card p-6">
          <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-white">AI 爆品推荐</h2>
            <button
          ...
          <p v-else class="text-gray-500 dark:text-gray-400 text-center py-8">暂无爆品推荐</p>
        </div>

        <!-- 最近活动 -->
        <div class="glass-card p-6">
          <h2 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">最近活动</h2>
          
          <!-- 最近搜索 -->
          <div v-if="recentActivity?.recentSearches.length" class="mb-6">
            <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">最近搜索</h3>
            <div class="space-y-2">
              <button
          ...
          <div v-if="recentActivity?.recentBrowsed.length">
            <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">最近浏览</h3>
            <div class="grid grid-cols-4 gap-2">
              <button
                v-for="product in recentActivity.recentBrowsed.slice(0, 4)"
                :key="product.id"
                @click="handleProductClick(product)"
                class="aspect-square rounded-lg overflow-hidden hover:ring-2 hover:ring-blue-500 transition-all"
              >
                <img
          ...
          <p v-if="!recentActivity?.recentSearches.length && !recentActivity?.recentBrowsed.length" class="text-gray-500 dark:text-gray-400 text-center py-8">
            暂无最近活动
          </p>
        </div>
      </div>
      ...
      <!-- 热门品类趋势图表 -->
      <div class="glass-card p-6">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">热门品类趋势</h2>
        <div
          ...
          style="height: 400px;"
        ></div>
        <p v-else class="text-gray-500 dark:text-gray-400 text-center py-8">暂无趋势数据</p>
      </div>
    </div>
  </div>
</template>
